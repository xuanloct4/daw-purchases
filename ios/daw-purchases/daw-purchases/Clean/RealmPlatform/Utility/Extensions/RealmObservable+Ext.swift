...
extension Observable where Element: Sequence, Element.Iterator.Element: RealmDomainConvertibleType {
...
extension Sequence where Iterator.Element: RealmDomainConvertibleType {
