...
protocol CoreDataAbstractRepository {
    associatedtype T
...
final class CoreDataRepository<T: CoreDataRepresentable>: CoreDataAbstractRepository where T == T.CoreDataType.DomainType {
